...
<xsl:transform xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
            ...
            <schxslt:rule pattern="d7e29">
               ...
               <xsl:if test="not(exists(cbc:UUID) and (cbc:UUID) != '' and matches(cbc:UUID, '^[\w.-]+'))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                     ...
                     <svrl:text>[BR-KSA-03]-The UUID (KSA-1) is mandatory and must contain only letters, numbers, and dashes.</svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
               <xsl:if test="not((cac:AdditionalDocumentReference[normalize-space(cbc:ID) = 'QR'] and exists(cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) and (cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) != '' and (cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject[normalize-space(@mimeCode) = 'text/plain'])))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-27">
                     ...
                     <svrl:text>[BR-KSA-27]-The document must contain a QR code (KSA-14).</svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
               ...
               <xsl:if test="not(matches(cac:AdditionalDocumentReference/cbc:UUID, '^[0-9]*$'))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                     ...
                     <svrl:text>[BR-KSA-34]-Each invoice must have an invoice counter value (KSA-16).</svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
               ...
               <xsl:if test="not((cac:AdditionalDocumentReference[normalize-space(cbc:ID) = 'PIH'] and exists(cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) and (cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) != '' and (cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject[normalize-space(@mimeCode) = 'text/plain']) and (cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) = 'NWZlY2ViNjZmZmM4NmYzOGQ5NTI3ODZjNmQ2OTZjNzljMmRiYzIzOWRkNGU5MWI0NjcyOWQ3M2EyN2ZiNTdlOQ=='))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-61">
               ...
               <xsl:if test="not(exists(cbc:IssueTime) and (cbc:IssueTime) != '' and matches(cbc:IssueTime, '^([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$'))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-70">
                     <xsl:attribute name="test">exists(cbc:IssueTime) and (cbc:IssueTime) != '' and matches(cbc:IssueTime, '^([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$')</xsl:attribute>
                     <svrl:text>[BR-KSA-70]-The timestamp (KSA-25) of the invoice is mandatory and must be of the format HH:MM:SS.</svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
            </schxslt:rule>
            <xsl:next-match>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e29">
               ...
               <xsl:if test="not(((substring(@name,1,2) = '01') or (substring(@name,1,2) = '02'))                 and ((substring(@name,3,1) = '0') or (substring(@name,3,1) = '1'))                 and ((substring(@name,4,1) = '0') or (substring(@name,4,1) = '1'))                 and ((substring(@name,5,1) = '0') or (substring(@name,5,1) = '1'))                 and ((substring(@name,6,1) = '0') or (substring(@name,6,1) = '1'))                 and ((substring(@name,7,1) = '0') or (substring(@name,7,1) = '1')))">
                ...
                - 01 for taxtax invoice
                - 02 for simplified taxtax invoice
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e29">
               ...
               <xsl:if test="not(contains(' CRN MOM MLS SAG OTH ', ./@schemeID)                 and (matches((.), '^[a-zA-Z0-9]*$')))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-08">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e29">
               ...
               <xsl:if test="not(contains(' NAT TIN IQA PAS CRN MOM MLS SAG GCC OTH ', ./@schemeID)                 and (matches((.), '^[a-zA-Z0-9]*$')))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-14">
   ...
   <xsl:template match="cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory"
      ...
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd7e29']">
            <schxslt:rule pattern="d7e29">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory" shadowed by preceding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
                  <xsl:attribute name="context">cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory</xsl:attribute>
               </svrl:suppressed-rule>
            </schxslt:rule>
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e29">
               ...
               <xsl:if test="not(contains(' S Z E O ', //cac:AllowanceCharge/cac:TaxCategory/cbc:ID) and                 contains(' S Z E O ', cbc:ID) and                 contains(' S Z E O ', //cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount/cac:TaxCategory/cbc:ID))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-18">
                     <xsl:attribute name="test">contains(' S Z E O ', //cac:AllowanceCharge/cac:TaxCategory/cbc:ID) and                 contains(' S Z E O ', cbc:ID) and                 contains(' S Z E O ', //cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount/cac:TaxCategory/cbc:ID)</xsl:attribute>
                     <svrl:text>[BR-KSA-18]-VAT category code must contain one of the values (S, Z, E, O).
            </svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
            </schxslt:rule>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e29">
               ...
               <xsl:if test="not(exists(cbc:EmbeddedDocumentBinaryObject) and (cbc:EmbeddedDocumentBinaryObject) != '' and (cbc:EmbeddedDocumentBinaryObject[normalize-space(@mimeCode) = 'text/plain']) and (cbc:EmbeddedDocumentBinaryObject) = 'NWZlY2ViNjZmZmM4NmYzOGQ5NTI3ODZjNmQ2OTZjNzljMmRiYzIzOWRkNGU5MWI0NjcyOWQ3M2EyN2ZiNTdlOQ==')">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-26">
                     <xsl:attribute name="test">exists(cbc:EmbeddedDocumentBinaryObject) and (cbc:EmbeddedDocumentBinaryObject) != '' and (cbc:EmbeddedDocumentBinaryObject[normalize-space(@mimeCode) = 'text/plain']) and (cbc:EmbeddedDocumentBinaryObject) = 'NWZlY2ViNjZmZmM4NmYzOGQ5NTI3ODZjNmQ2OTZjNzljMmRiYzIzOWRkNGU5MWI0NjcyOWQ3M2EyN2ZiNTdlOQ=='</xsl:attribute>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e29">
               ...
               <xsl:if test="not(xs:date(.) &gt; xs:date(../cbc:ActualDeliveryDate) )">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-36">
   ...
   <xsl:template match="cac:AdditionalDocumentReference[normalize-space(cbc:ID) = 'QR']/cac:Attachment"
                 priority="32"
                 mode="d7e29">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd7e185']">
            <schxslt:rule pattern="d7e185">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "cac:AdditionalDocumentReference[normalize-space(cbc:ID) = 'QR']/cac:Attachment" shadowed by preceding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
                  <xsl:attribute name="context">cac:AdditionalDocumentReference[normalize-space(cbc:ID) = 'QR']/cac:Attachment</xsl:attribute>
               </svrl:suppressed-rule>
            </schxslt:rule>
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e185">
               ...
               <xsl:if test="not(exists(cbc:EmbeddedDocumentBinaryObject) and (cbc:EmbeddedDocumentBinaryObject) != '' and matches(cbc:EmbeddedDocumentBinaryObject, '^([A-Za-z0-9+/]{4})*([A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{2}==)?$'))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-Propsal">
                     <xsl:attribute name="test">exists(cbc:EmbeddedDocumentBinaryObject) and (cbc:EmbeddedDocumentBinaryObject) != '' and matches(cbc:EmbeddedDocumentBinaryObject, '^([A-Za-z0-9+/]{4})*([A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{2}==)?$')</xsl:attribute>
                     <svrl:text>[BR-KSA-Proposal]-The document QR code must be base64Binary</svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
            </schxslt:rule>
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
                               as="xs:string*"
                               select="($schxslt:patterns-matched, 'd7e185')"/>
            </xsl:next-match>
         </xsl:otherwise>
      </xsl:choose>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e212">
               ...
               <xsl:if test="not(matches(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone, '^[0-9]{5}$'))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-67">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e255">
               ...
               <xsl:if test="not(exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PlotIdentification) and matches(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PlotIdentification, '^[0-9]{4}$'))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-65">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e301">
               ...
               <xsl:if test="not(matches(//cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID, '^[0-9]{15}$') and starts-with(//cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID, '3') and ends-with(//cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID, '3'))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-44">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e328">
               ...
               <xsl:if test="not(xs:decimal(.) &gt;= 0 and xs:decimal(.) &lt;= 100 and string-length(substring-after(.,'.')) &lt;=6)">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-DEC-01">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e355">
               ...
               <xsl:if test="not(matches(normalize-space(//cbc:DocumentCurrencyCode), @currencyID))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-CL-02">
            ...
            <schxslt:rule pattern="d7e355">
               ...
               <xsl:if test="not(exists(cbc:TaxExemptionReasonCode) and ((not(contains(normalize-space(cbc:TaxExemptionReasonCode), ' ')) and contains(' VATEX-SA-29 VATEX-SA-29-7 VATEX-SA-30 VATEX-SA-32 VATEX-SA-33 VATEX-SA-34-1 VATEX-SA-34-2 VATEX-SA-34-3 VATEX-SA-34-4 VATEX-SA-34-5 VATEX-SA-35 VATEX-SA-36 VATEX-SA-EDU VATEX-SA-HEA ', concat(' ', normalize-space(cbc:TaxExemptionReasonCode), ' ')))))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                     ...
                     <svrl:text>[BR-KSA-CL-04]-VAT exemption reason code (BT-121) must exists in the invoice, the codescodes Z, E must have Tax exemption (or exceptionexceptions) reason code and text - specific to Saudi Arabia.</svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e385">
               ...
               <xsl:if test="not(count(*) != 0 or (.) != '')">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
                                      id="BR-KSA-F-03">
                     <xsl:attribute name="test">count(*) != 0 or (.) != ''</xsl:attribute>
                     <svrl:text>[BR-KSA-F-03]-Document MUST not contain empty elements.</svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
            </schxslt:rule>
            <xsl:next-match>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e416">
               ...
               <xsl:if test="not(xs:decimal(./cbc:Amount) = (xs:decimal(./cbc:BaseAmount) * xs:decimal(./cbc:MultiplierFactorNumeric) div 100))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="fatal"
            ...
            <schxslt:rule pattern="d7e416">
               ...
               <xsl:if test="not(((exists(cac:Price/cbc:BaseQuantity) and xs:decimal(cbc:LineExtensionAmount) = xs:decimal(cbc:InvoicedQuantity) * ((xs:decimal(cac:Price/cbc:PriceAmount) div                 xs:decimal(cac:Price/cbc:BaseQuantity)) - xs:decimal(sum(cac:Price/cac:AllowanceCharge/cbc:Amount))))) or ((not(exists(cac:Price/cbc:BaseQuantity)) and xs:decimal(cbc:LineExtensionAmount) = xs:decimal(cbc:InvoicedQuantity) * xs:decimal(cac:Price/cbc:PriceAmount) - xs:decimal(sum(cac:Price/cac:AllowanceCharge/cbc:Amount)))))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                     ...
                     <svrl:text>[BR-KSA-EN16931-11]-Invoice line net amount (BT-131) must equal (Invoiced quantity (BT-130) * (Item net price (BT-146) / item price base quantity (BT-149))-))- Sum of invoice line allowance amount (BT-136)</svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
            </schxslt:rule>
            <xsl:next-match>
