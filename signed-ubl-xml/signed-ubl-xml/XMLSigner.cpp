...
void XMLSigner::SetupDSigGen()
{
    ...
    object1.UpdateChildContent("xades:SignedProperties|xades:SignedSignatureProperties|xades:SignaturePolicyIdentifier", "should-be-filled");
...
bool XMLSigner::LoadCertificate()
{
    bool success = _cert.LoadPfxFile(_certPath, _certPwd);
    if (success != true) {
...
void XMLSigner::SaveSbXml(CkStringBuilder& sb, const char* filepath)
{
    ...
    tempXml.SaveXml("../Samples/signedXml.xml");
}
...
bool XMLSigner::SignXML(CkXml& doc)
{
    SetupDSigGen();
    ...
    SaveSbXml(sbXml, "../Samples/signedXml.xml");
